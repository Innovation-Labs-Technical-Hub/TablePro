...
Detailed architecture, invariant, build, style, and release guidance shared by Claude Code and Codex.
Load only the sections relevant to the files and behavior under change.
