...
Report as structured text with evidence. Change nothing. Say "not confirmed" rather than guessing.
...
Report as structured text with citations, separating what you confirmed from what you inferred.
  `, { label: 'platform' }),
...
credible descriptions. Flag every claim as CONFIRMED (with a URL) or INFERRED.
  `, { label: 'ux' }),
...
edited and whatever you find will be fixed in its own pull request this session.
